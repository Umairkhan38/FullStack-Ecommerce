              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                <div className="flex h-16 items-center justify-between">
                  ...
                  <div className="flex items-center">
                    ...
                    <h3 class="text-2xl font-bold text-white ml-2">Quickshop.com</h3>
                  ...
                  <div className="hidden md:block">
                   ...
                   { cart.length?<span className="inline-flex items-center rounded-md mb-7 -ml-3 bg-red-700 px-2 py-1 text-xs font-medium text-white ring-1 ring-inset ring-red-600/10">
                        {cart.length}
                      </span>:null}
              ...
              <Disclosure.Panel className="md:hidden">
                ...
                <div className="border-t border-gray-700 pb-3 pt-4">
                  <div className="flex items-center px-5">
                   ...
                   {cart.length?<span className="inline-flex items-center rounded-md bg-red-50 mb-7 -ml-3 px-2 py-1 text-xs font-medium text-red-700 ring-1 ring-inset ring-red-600/10">
                        {cart.length}
                    </span>:null}
                  </div>
